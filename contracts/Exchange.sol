...
contract Exchange {
  ...
  function cancelOrder(uint256 _id) public {
    ...
    // Ensure te caller of the function is the owner of the order
  ...
  function _trade(
    ...
    // Execute trade
    // msg.sender is the user that filled the order, while _user is who created the order
